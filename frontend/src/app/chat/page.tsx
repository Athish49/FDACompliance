  ...
  return (
    <>
      ...
      <div className="flex flex-col h-screen pt-[calc(2rem+56px)]">
        {/* Sub-header */}
        <div className="border-b border-sand-200/60 bg-sand-25/85 backdrop-blur-sm">
          <div className="max-w-3xl mx-auto px-6 py-3 flex items-center justify-between">
            ...
            <h1 className="text-sm font-medium text-bark-900">Compliance Chat</h1>
            <button
              onClick={handleClear}
            ...
            <AnimatePresence mode="wait">
              {!hasMessages && !isLoading ? (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="flex flex-col items-center justify-center min-h-[56vh]"
                >
                  <div className="w-16 h-16 rounded-2xl bg-sunlight/30 border border-sunlight flex items-center justify-center mb-6">
                    <svg className="w-8 h-8 text-bark-900/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
                    </svg>
                  </div>
                  <h2 className="font-serif text-2xl text-bark-900 mb-2">Ask about FDA regulations</h2>
                  <p className="text-sm text-bark-700/45 mb-8 text-center max-w-md">
                    Get instant, citation-backed answers about 21 CFR food labeling requirements.
                  </p>
                  ...
                  <div className="w-full max-w-lg space-y-2.5">
                    {SUGGESTIONS.map((s) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-3 text-sm text-bark-700/70 bg-white border border-sand-200 rounded-xl hover:border-bark-900/15 hover:bg-sand-50 transition-all"
                      >
                        {s}
                      </button>
                    ))}
        ...
        {/* Input bar */}
        <div className="border-t border-sand-200/60 bg-sand-25/85 backdrop-blur-sm">
